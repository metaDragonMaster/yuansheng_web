<template>
	<el-form ref="Form" :model="Form" :rules="Rules" label-position="right" label-width="160px">
		<!-- <el-form-item label="农资商" ></el-form-item> -->
		<el-form-item prop="name" label="商户名称"><el-input v-model="Form.name" clearable /></el-form-item>
...
export default {
	data() {
		return {
			// Form: {
			// 	name: '商户名称', //商户名称		false	string
			// 	merchantType:0, //商户类型（0 个人 1企业）
			// 	licenseCode: '123', //		营业执照编号		false	string
			// 	mcc: '123', //经营类目		false	string
			// 	realName: '123', //法人姓名		false	string
			// 	certificationNo: '123', //身份证号码		false	string
			// 	address: '123', //详细地址		false	string
			// 	cityNo: [110000, 110100, 110101], //所在城市		false	string
			// 	contactName: '123', //联系人姓名
			// 	contactCertificationNo: '4433', //	联系人身份证号码
			// 	contactPhoneNo: '111' ,//联系人电话号码
			// },
			Form: {
	...
	methods: {
		...
		// startForm() {
		// 	this.$nextTick(() => {
		// 		this.$refs['SelectAddressDom'].startAreas(this.Form.cityNo);
		// 	});
		// },
		submit($enent) {
