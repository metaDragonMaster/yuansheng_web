<template>
	<el-form ref="Form" :model="Form" :rules="Rules" label-position="right" label-width="160px">
		<!-- {{Form}} -->
		<!-- <el-form-item label="合伙企业" ></el-form-item> -->
		...
		<el-form-item prop="cityNo" label="所在地区">
			<SelectAddress ref="SelectAddressDom" v-model="Form.cityNo"></SelectAddress></el-form-item>
			...
			this.$refs['Form'].validate(valid => {
				if (valid) {
					if (this.$refs['readDom'].read == true) {
						...
						this.setAuthenType('cooperativeId');
					} else {
